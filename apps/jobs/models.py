...
class CV(models.Model):
    ...
    birthday = models.CharField(max_length=255, verbose_name="Дата рождения")
    ...
    child_birthday = models.CharField(max_length=255, verbose_name="День рождение", blank=True, null=True)
    ...
    qualification_start = models.CharField(max_length=255, verbose_name="Дата начала", blank=True, null=True)
    qualification_end= models.CharField(max_length=255, verbose_name="Дата окончания", blank=True, null=True)
    ...
    last_job_start = models.CharField(max_length=255, verbose_name="Дата начала", blank=True, null=True)
    last_job_end= models.CharField(max_length=255, verbose_name="Дата окончания", blank=True, null=True)
    ...
    advisor_start = models.CharField(max_length=255,  verbose_name="Дата начала", blank=True, null=True)
    advisor_end= models.CharField(max_length=255, verbose_name="Дата окончания", blank=True, null=True)
    ...
    internship_salary = models.CharField(max_length=255,verbose_name="Желаемый размер Вашего вознаграждения на стажерский период")
    job_salary = models.CharField(max_length=255,verbose_name="Желаемый размер Вашего вознаграждения на основной период")
    ...
    google_docs = models.BooleanField(default=False, verbose_name="Google Документы")
    google_tables = models.BooleanField(default=False, verbose_name="Google Таблицы")
    google_presentation = models.BooleanField(default=False, verbose_name="Google Презентации")
    prezi = models.BooleanField(default=False, verbose_name="Prezi")
    touch_typing = models.BooleanField(default=False, verbose_name="Слепая печать")
    abroad_country = models.CharField(max_length=100, verbose_name="Пребывание за границей")
    abroad_start = models.CharField(max_length=255, verbose_name="Дата начала", blank=True, null=True)
    abroad_end = models.CharField(max_length=255, verbose_name="Дата окончания", blank=True, null=True)
    ...
    edu_start = models.CharField(max_length=255, verbose_name="Начало обучения", null=True, blank=True)
    edu_end = models.CharField(max_length=255, verbose_name="Конец обучения", null=True, blank=True)
    edu_country = models.CharField(max_length=255, verbose_name="Страна Университета", null=True, blank=True, default=None)
    ...
    acq_title = models.CharField(max_length=255, verbose_name="Должность", null=True, blank=True, default=None)
    acq_start = models.CharField(max_length=255, verbose_name="Дата начала", null=True, blank=True)
    ...
    laptop = models.BooleanField(verbose_name="Имеется ли у Вас ноутбук?", default=False, null=True)
